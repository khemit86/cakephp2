...
class UploadComponent extends Component {
    ...
    **/
    ...
    public function image($file, $type, $size, $output = NULL, $quality = NULL) {
 	 ...
 	 */
			...
			case 'custom_crop___':
                ...
                $dstImg = imageCreateTrueColor($maxW, $maxH);
                ImageCopyResampled($dstImg, $srcImg, $c_x,$c_y, $startX, $startY, $maxW, $maxH, $maxW, $maxH);
    ...
    public function __resize($filepath, $filename, $type, $size, $output = NULL, $quality = NULL) {
