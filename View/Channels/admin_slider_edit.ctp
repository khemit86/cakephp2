	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<!-- form start -->
				<?php 
					echo($this->Form->create('RecordingStream', array('url' => array('controller' => 'channels', 'action' => 'slider_edit'),'class'=>'form-horizontal','type'=>'file')));
					...
					echo($this->Form->hidden('RecordingStream.is_home', array('value' => 1)));
