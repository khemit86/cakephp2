<div class="right-contant" style="min-height:500px;text-align:center;">
		...
		<form action="<?php echo $paypal_url ?>" method="post" name="frmPayPal1" style="display:none;">
			...
			<input type="hidden" name="item_name" value="<?php echo $stream_detail['Stream']['title'];?>">
			<input type="hidden" name="item_number" value="<?php echo $stream_detail['Stream']['id']; ?>">
			...
			<input type="hidden" name="cancel_return" value="<?php echo Configure::read('App.SiteUrl')."streams/paypal_cancel_donate_stream/".$stream_detail['Stream']['id'] ?>" >
			<input type="hidden" name="return" value="<?php echo Configure::read('App.SiteUrl')."streams/paypal_return_donate_stream/".$stream_detail['Stream']['id'] ?>">
			<input type="hidden" name="notify_url" value="<?php echo Configure::read('App.SiteUrl')."streams/paypal_notify_donate_stream" ?>">
