...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Live Streaming List</li>
	</ol>
</section>
<!-- Main content -->
<section class="content">
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
			<?php echo($this->Form->create('Stream', array('url'=>array('controller' => 'streams', 'action' => 'index'))));?>
					...
					<table id="example1" class="table table-bordered table-striped table-mailbox">
						...
						?>
								...
								<td><?php echo ($this->Admin->getActionImage(
										array(
											'view' => array('controller' => 'streams', 'action' => 'detail'),											
...
<script type="text/javascript">
	$(function() {
		...
		$('.stream_feature').on('click',function(){	
