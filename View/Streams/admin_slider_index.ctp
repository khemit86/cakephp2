...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
			<?php echo($this->Form->create('Stream', array('url'=>array('controller' => 'streams', 'action' => 'slider_index'))));?>
					...
					<div class="box box-danger">
						...
						<div class="box-body">
							<div class="row">
								...
								<div class="col-xs-3">
									Title 
									<?php echo($this->Form->input('Stream.title', array('placeholder'=>"Title",'label' => false, 'div'=>false,'class'=>'form-control'))); ?>
								</div>
								<?php /* 
								<div class="col-xs-3">
									Description 
									<?php echo($this->Form->input('Stream.stream_bio', array('placeholder'=>"Description",'label' => false, 'div'=>false,'class'=>'form-control'))); ?>
								</div>
								 */ ?>
								<div class="col-xs-3">
									Channel Name
					...
					<table id="example1" class="table table-bordered table-striped table-mailbox">
						...
						?>
						    <tr id="sort_<?php echo $value['Stream']['id']; ?>">
								...
								<td>
									<?php									
										$image		=	$value['Stream']['stream_image'];										
										$noImage	=	'avatar5.png';
								...
								<td><?php echo $value['Stream']['stream_bio'];?></td>
								...
								<td>									
									...
									echo ($this->Html->link($status_html, array('controller'=>'streams','action' => 'video_status', $value['Stream']['id'], 'token' => $this->params['_Token']['key']), array('escape'=>false,'title' => $value['Stream']['status'] == 1 ? 'Inactive' : 'Active')));
									?>
								</td>
								
								<td>
									<?php /* echo $this->Html->link("Edit", array('controller'=>'streams', 'action'=>'slider_edit',$value['Stream']['id']), array("title"=>"", "escape"=>false ,'class'=>'btn btn-primary')); */ ?>
									
									<?php echo $this->Html->link("View", array('controller'=>'streams', 'action'=>'slider_view',$value['Stream']['id']), array("title"=>"", "escape"=>false ,'class'=>'btn btn-primary')); ?>
								</td>
