...
class ImageHelper extends AppHelper{
    ...
    public function resize($image, $width, $height, $options = array(), $quality = 100){
		...
		if($this->params['controller'] == 'web_services') {
			 return SITE_URL.'/'.$this->resizedUrl($image, $width, $height, $quality);
		} else {
			return $this->Html->image(SITE_URL.'/'.$this->resizedUrl($image, $width, $height, $quality), $options);
		}
