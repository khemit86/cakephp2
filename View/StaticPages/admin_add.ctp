	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<!-- form start -->
				<?php 
					echo($this->Form->create('StaticPage', array('url' => array('controller' => 'static_pages', 'action' => 'add'),'class'=>'form-horizontal','type'=>'file')));
