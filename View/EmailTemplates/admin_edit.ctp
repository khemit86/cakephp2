...
<section class="content-header">
	<h1>
		Dashboard 
		<small>Email Templates Edit</small>
	</h1>
	<ol class="breadcrumb">
		...
		<li class="active">Email Templates Edit</li>
	</ol>
</section>
<!-- Main content -->
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<!-- form start -->
				<?php 
				echo($this->Form->create('EmailTemplate', array('url' => array('controller' => 'email_templates', 'action' => 'edit'),'class'=>'form-horizontal')));
				echo($this->Form->hidden('token_key', array('value' => $this->params['_Token']['key'])));
				echo($this->Form->hidden('EmailTemplate.id'));
				?>
					<div class="box-body">
					...
					<div class="box-footer">
						<?php echo $this->Html->link("Back", array('controller'=>'email_templates', 'action'=>'index'), array("title"=>"", "escape"=>false ,'class'=>'btn btn-primary')); ?>
